...
ActiveRecord::Schema.define(version: 2021_03_18_094425) do
  ...
  create_table "hikers", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["email"], name: "index_hikers_on_email", unique: true
